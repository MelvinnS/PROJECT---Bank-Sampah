  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] w-full overflow-hidden">
        ...
        <div className="absolute top-2.5 right-2.5 flex h-6 w-6 items-center justify-center rounded-full bg-[#153d23]/80 text-white backdrop-blur-[2px] shadow-xs">
      ...
      <div className="flex flex-1 flex-col gap-1 p-3 sm:p-3.5">
        <div className="flex items-center justify-between gap-1">
          <p className="truncate text-xs sm:text-sm font-bold text-ink group-hover:text-[#153d23] transition-colors">
            {nama}
          </p>
          <ChevronRight size={15} className="shrink-0 text-gray-300 group-hover:text-[#153d23] transition-colors" />
        </div>
